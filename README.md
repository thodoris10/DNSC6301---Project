...
* **Unexpected results**: 
* The absence of missing values is the first unexpected result of our model. Secondly, as illustrated in the figure below, the variable "PAY 0" appears to have a substantive variable importance for our model. 
